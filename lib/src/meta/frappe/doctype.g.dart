...
DocType _$DocTypeFromJson(Map<String, dynamic> json) {
  return DocType()
    ...
    ..disabledFields = (json['_fields'] as List)
        ?.map((e) =>
            e == null ? null : DocField.fromJson(e as Map<String, dynamic>))
        ?.toList()
    ...
    ..permissions = (json['permissions'] as List)
        ?.map((e) =>
            e == null ? null : DocPerm.fromJson(e as Map<String, dynamic>))
        ?.toList()
    ...
    ..kanbanColumnFields = json['__kanban_column_fields'] as List
