...
AssignDocParams _$AssignDocParamsFromJson(Map<String, dynamic> json) {
  return AssignDocParams(
    ...
    bulkAssign: json['bulk_assign'] as bool,
  )
    ..cmd = json['cmd'] as String
...
GetDocsAssignedToUserParams _$GetDocsAssignedToUserParamsFromJson(
  ...
  return GetDocsAssignedToUserParams(
...
GetDocsAssignedToUserResponse _$GetDocsAssignedToUserResponseFromJson(
    Map<String, dynamic> json) {
  return GetDocsAssignedToUserResponse(
...
CompleteDocAssignmentParams _$CompleteDocAssignmentParamsFromJson(
    Map<String, dynamic> json) {
  return CompleteDocAssignmentParams(
    doctype: json['doctype'] as String,
    name: json['name'] as String,
...
FrappeReport _$FrappeReportFromJson(Map<String, dynamic> json) {
  return FrappeReport()
    ..result = (json['result'] as List)?.map((e) => e as List)?.toList()
    ..columns = (json['columns'] as List)
        ?.map((e) => e == null
            ? null
            : FrappeReportColumn.fromJson(e as Map<String, dynamic>))
        ?.toList();
}
...
FrappeLog _$FrappeLogFromJson(Map<String, dynamic> json) {
  return FrappeLog()
    ..doctype = json['doctype'] as String
    ..name = json['name'] as String
    ..owner = json['owner'] as String
    ...
    ..tags = (json['tags'] as List)
        ?.map((e) =>
            e == null ? null : FrappeLogTag.fromJson(e as Map<String, dynamic>))
        ?.toList()
    ..tagsList = (json['tags_list'] as List)?.map((e) => e as String)?.toList();
}
...
FrappeLogTag _$FrappeLogTagFromJson(Map<String, dynamic> json) {
  return FrappeLogTag()
    ..doctype = json['doctype'] as String
    ..name = json['name'] as String
    ..owner = json['owner'] as String
